...
const I18N = {
  ...
  mobileTitle:    { zh: "建议使用电脑访问", en: "Best viewed on a computer" },
  mobileMsg:      { zh: "本编辑器专为桌面端设计，需要鼠标与较大屏幕。手机端可能无法正常操作节点、连线与菜单。", en: "This editor is built for desktop and needs a mouse and a large screen. Nodes, links, and menus may not work properly on a phone." },
  mobileContinue: { zh: "仍要继续", en: "Continue anyway" },
  toolsMenu:      { zh: "工具 ▾", en: "Tools ▾" },
  syncTextItem:   { zh: "台词同步", en: "Sync Dialogue Text" },
  syncTextNoCol:  { zh: "数据中没有 zh-CN（中文台词）列，无法同步", en: "The data has no zh-CN column; nothing to sync" },
  syncTextNone:   { zh: "当前对话没有需要同步的台词", en: "Nothing to sync in the current conversation" },
  syncTextConfirm: { zh: "将在当前对话同步 {n} 个节点：\n· {a} 个节点用「台词文本」填充「中文台词」\n· {b} 个节点用「中文台词」填充「台词文本」\n\n确认执行？（可用 Ctrl+Z 撤销）", en: "This will sync {n} entries in the current conversation:\n· {a} entries: fill zh-CN from Dialogue Text\n· {b} entries: fill Dialogue Text from zh-CN\n\nProceed? (Ctrl+Z to undo)" },
  syncTextDone:   { zh: "已同步 {n} 个节点的台词", en: "Synced dialogue text of {n} entries" },
  ...
  newProjectTitle: { zh: "新建空白项目", en: "Create a blank project" },
  fldProjName:    { zh: "项目名称", en: "Project name" },
  fldAuthor:      { zh: "作者", en: "Author" },
  fldVersion:     { zh: "版本", en: "Version" },
  fldDescription: { zh: "描述", en: "Description" },
  create:         { zh: "创建", en: "Create" },
  confirmDiscardNew: { zh: "当前有未导出的修改，创建新项目将丢弃它们。继续？", en: "You have unexported changes. Creating a new project will discard them. Continue?" },
  projectCreated: { zh: "已创建新项目 {f}", en: "Created new project {f}" },
  ...
  /* ---------- Google Drive ---------- */
  gdOpen:         { zh: "从 Google Drive 打开…", en: "Open from Google Drive…" },
  gdSaveCsv:      { zh: "保存 CSV 到 Google Drive", en: "Save CSV to Google Drive" },
  gdSaveAdg:      { zh: "保存 ATLADG 到 Google Drive", en: "Save ATLADG to Google Drive" },
  gdSignIn:       { zh: "登录 Google", en: "Sign in with Google" },
  gdSignedIn:     { zh: "已连接 Google 账号", en: "Google account connected" },
  gdSignOutItem:  { zh: "断开 Google 账号", en: "Disconnect Google account" },
  gdSignedOut:    { zh: "已断开 Google 账号", en: "Google account disconnected" },
  gdLoading:      { zh: "Google 组件尚未加载完成，请稍后重试", en: "Google components are still loading, please retry shortly" },
  gdAuthFail:     { zh: "Google 授权失败：{msg}", en: "Google authorization failed: {msg}" },
  gdDownloadFail: { zh: "从 Drive 下载失败：{msg}", en: "Download from Drive failed: {msg}" },
  gdSaveFail:     { zh: "保存到 Drive 失败：{msg}", en: "Saving to Drive failed: {msg}" },
  gdSaved:        { zh: "已保存到 Google Drive：{f}（覆盖原文件）", en: "Saved to Google Drive: {f} (overwrote the original)" },
